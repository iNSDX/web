				...
				<div class="wrapper style1 Site-content">
					 <div class="container">
						 <article id="main" class="special">
							 <header>
								 <h2><a href="cigarrillos.php">Cigarrillos</a></h2>
								 <p>
								...
								<div class="w3-row-padding">
									...
									?>
										<div class="w3-quarter w3-container w3-margin-bottom">
									  	<img src="images/articulos/<?php echo $fila['IDARTICULO']; ?>.jpg" alt="<?php echo $fila['NOMBRE']; ?>" class="img-pequeña 10u">
						   ...
						   <div class="w3-center w3-padding-32">
						     <div class="w3-bar">
									 ...
									 <?php }	else { ?>
												 <a href="cigarrillos.php?PAG_NUM=<?php echo $pagina; ?>&PAG_TAM=<?php echo $pag_tam; ?>" class="w3-bar-item w3-button w3-hover-black"><?php echo $pagina; ?></a>
									 <?php } ?>
						     </div>
						   </div>
