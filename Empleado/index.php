				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<!-- Header -->
								<header id="header">
									<a href="index.html" class="logo"><strong>Dependiente</strong> NOMBRE </a>
								</header>
								...
								<section id="banner">
									<div class="content">
										<header>
											...
											<p>Esta es la interfaz de dependiente.</p>
										</header>
										...
										<ul class="actions">
											<li><a href="nVenta.php" class="button big">Nueva Venta</a></li>
										</ul>
									</div>
