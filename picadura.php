	 			 ...
	 			 ?>
					 ...
					 <div class="container">
						 <article id="main" class="special">
							 <header>
								 <h2><a href="picadura.php">Picadura</a></h2>
								 <p>
								 ...
								 <nav>
									<form method="get" action="picadura.php">
						   ...
						   <div class="w3-center w3-padding-32">
						     <div class="w3-bar">
									 ...
									 <?php }	else { ?>
												 <a href="picadura.php?PAG_NUM=<?php echo $pagina; ?>&PAG_TAM=<?php echo $pag_tam; ?>" class="w3-bar-item w3-button w3-hover-black"><?php echo $pagina; ?></a>
									 <?php } ?>
						     </div>
						   </div>
