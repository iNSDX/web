	 			 ...
	 			 ?>
					 ...
					 <div class="container">
						 <article id="main" class="special">
							 <header>
								 <h2><a href="golosinas.php">Golosinas</a></h2>
								 <p>
							 ...
							 <nav>
								<form method="get" action="golosinas.php">
								...
								<div class="w3-row-padding">
									...
									?>
										<div class="w3-quarter w3-container w3-margin-bottom">
									  	<img src="images/articulos/<?php echo $fila['IDARTICULO']; ?>.jpg" alt="<?php echo $fila['NOMBRE']; ?>" style="width:100%" class="img-pequeña">
						   ...
						   <div class="w3-center w3-padding-32">
						     <div class="w3-bar">
									 ...
									 <?php }	else { ?>
												 <a href="golosinas.php?PAG_NUM=<?php echo $pagina; ?>&PAG_TAM=<?php echo $pag_tam; ?>" class="w3-bar-item w3-button w3-hover-black"><?php echo $pagina; ?></a>
									 <?php } ?>
						     </div>
						   </div>
